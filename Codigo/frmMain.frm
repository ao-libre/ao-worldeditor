...
Begin VB.Form frmMain 
   ...
   Begin VB.Menu mnuEdicion 
      ...
      Begin VB.Menu mnuCortar 
         Caption         =   "C&ortar Selecci鏮"
         Shortcut        =   ^X
      End
      Begin VB.Menu mnuCopiar 
         Caption         =   "&Copiar Selecci鏮"
         Shortcut        =   ^C
      End
      Begin VB.Menu mnuPegar 
         Caption         =   "&Pegar Selecci鏮"
         Shortcut        =   ^V
      End
      Begin VB.Menu mnuBloquearS 
         Caption         =   "&Bloquear Selecci鏮"
         Shortcut        =   ^B
      End
      Begin VB.Menu mnuRealizarOperacion 
         Caption         =   "&Realizar Operaci鏮 en Selecci鏮"
         Shortcut        =   ^D
      End
      Begin VB.Menu mnuDeshacerPegado 
         Caption         =   "Deshacer P&egado de Selecci鏮"
         Shortcut        =   ^S
      End
      ...
      Begin VB.Menu mnuAutoCapturarSuperficie 
         Caption         =   "Auto-C&apturar informaci鏮 de la Superficie"
      End
      Begin VB.Menu mnuAutoCapturarTranslados 
         Caption         =   "Auto-&Capturar informaci鏮 de los Translados"
         Checked         =   -1  'True
      End
      Begin VB.Menu mnuAutoGuardarMapas 
         Caption         =   "Configuraci鏮 de Auto-&Guardar Mapas"
      End
   End
   ...
   Begin VB.Menu mnuOpciones 
      ...
      Begin VB.Menu mnuGuardarUltimaConfig 
         Caption         =   "&Guardar Ultima Configuraci鏮"
      End
   End
...
Private Sub mnuBloquearS_Click()
    ...
    '*************************************************
    Call modEdicion.Deshacer_Add("Bloquear Selecci鏮")
...
Private Sub mnuCortar_Click()
    ...
    'Last modified: 01/11/08
    '*************************************************
    Call modEdicion.Deshacer_Add("Cortar Selecci鏮")
...
Private Sub mnuDeshacerPegado_Click()
    ...
    'Last modified: 01/11/08
    '*************************************************
    Call modEdicion.Deshacer_Add("Deshacer Pegado de Selecci鏮")
    Call DePegar
...
Private Sub mnuPegar_Click()
    ...
    'Last modified: 01/11/08
    '*************************************************
    Call modEdicion.Deshacer_Add("Pegar Selecci鏮")
    Call PegarSeleccion
...
Private Sub mnuRealizarOperacion_Click()
    ...
    'Last modified: 01/11/08
    '*************************************************
    Call modEdicion.Deshacer_Add("Realizar Operaci鏮 en Selecci鏮")
